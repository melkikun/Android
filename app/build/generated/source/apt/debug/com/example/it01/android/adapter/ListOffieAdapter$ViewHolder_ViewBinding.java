...
public class ListOffieAdapter$ViewHolder_ViewBinding implements Unbinder {
  private ListOfficeAdapter.ViewHolder target;

  @UiThread
  public ListOffieAdapter$ViewHolder_ViewBinding(ListOfficeAdapter.ViewHolder target, View source) {
    this.target = target;
