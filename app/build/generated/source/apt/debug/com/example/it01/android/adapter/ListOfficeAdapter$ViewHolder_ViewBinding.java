...
public class ListOfficeAdapter$ViewHolder_ViewBinding implements Unbinder {
  private ListOfficeAdapter.ViewHolder target;

  @UiThread
  public ListOfficeAdapter$ViewHolder_ViewBinding(ListOfficeAdapter.ViewHolder target,
      View source) {
    this.target = target;
